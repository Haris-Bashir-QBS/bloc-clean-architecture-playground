...
//           ?.map((e) => UserLis.fromJson(e as Map<String, dynamic>))
//           .toList() ??
//           [],
//     );
//   }
...
//       'data': users?.map((e) => (e as UserProfileModel).toJson()).toList(),
//     };
//   }
...
//       users: users ?? this.users?.map((user) => user as UserProfileModel).toList(),
//     );
//   }
// }
//
